...
export default function TextForms(props) {
  ...
  return (
    ...
    <div>
      ...
      <textarea className="form-control"value={text} onClick={handleOnChange} style={{backgroundColor:props.mode==='light'?'#fff6e6':'#67573ee2'}} id="exampleFormControlTextarea1" rows="12"></textarea>
      </div>
